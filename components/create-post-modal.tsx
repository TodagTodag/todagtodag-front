...
import { Heart, Shield, Send, X, Loader2 } from "lucide-react"
...
export function CreatePostModal({ isOpen, onClose, onSubmit, isSubmitting = false }: CreatePostModalProps) {
